...
def login():
    st.title("Login")
    logo = Image.open("/mnt/data/image.png")  # Path ke logo yang di-upload
    st.image(logo, width=180)  # Menampilkan logo Starcom
    ...
    # Menampilkan pesan tambahan saat login belum berhasil
    st.markdown("### Sakeudap nuju di evaluasi KPI na, hanupis cuy")
