...
# Load the Excel file containing KPI data from GitHub raw URL
url = "https://raw.githubusercontent.com/username/repository/main/Data%20KPI%20Deviasi.xlsx"  # Replace with actual URL
data_kpi = pd.read_excel(url)

# Function to generate audio file
def generate_audio(text):
    # Define audio file path where Streamlit can access
