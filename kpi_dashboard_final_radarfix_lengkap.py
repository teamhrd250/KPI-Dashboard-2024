...
if 'logged_in' not in st.session_state or not st.session_state.logged_in:
    ...
    with col_pie:
        ...
        st.subheader("🧱 Nine Box Grid - Role-Based Layout")

        import plotly.graph_objects as go

        box_labels = [
            ["Develop<br><span style='font-size:10px'>(Untapped Talent)</span>",
             "Develop/Stretch<br><span style='font-size:10px'>(High Potentials)</span>",
             "Stretch<br><span style='font-size:10px'>(Exceptional Talent)</span>"],
            ["Observe - Dilemma<br><span style='font-size:10px'>(Inconsistent Performers)</span>",
             "Core<br><span style='font-size:10px'>(Reliable Team Players)</span>",
             "Stretch/Develop<br><span style='font-size:10px'>(Strong Contributors)</span>"],
            ["Observe/Terminate<br><span style='font-size:10px'>(Underperformers)</span>",
             "Observe - Effective<br><span style='font-size:10px'>(Effective Performers)</span>",
             "Trust<br><span style='font-size:10px'>(Trusted Professionals)</span>"]
        ]

        z_values = [[1]*3 for _ in range(3)]
        ...
        fig.update_layout(
            title="Nine Box Grid - Performance vs Potential",
            xaxis=dict(title="Performance", side="bottom"),
            yaxis=dict(title="Potential", autorange='reversed'),
            height=500
        )
